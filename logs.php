...
?>
  ...
  <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
    <li class="nav-item" role="presentation">
      <button class="nav-link active" id="pills-input-tab" data-bs-toggle="pill" data-bs-target="#pills-input" type="button" role="tab">Log Penginputan</button>
    </li>
    <li class="nav-item" role="presentation">
      <button class="nav-link" id="pills-borrow-tab" data-bs-toggle="pill" data-bs-target="#pills-borrow" type="button" role="tab">Log Peminjaman & Pengembalian</button>
    </li>
    <li class="nav-item" role="presentation">
      <button class="nav-link" id="pills-take-tab" data-bs-toggle="pill" data-bs-target="#pills-take" type="button" role="tab">Log Pengambilan</button>
    </li>
  </ul>
  ...
  <div class="tab-content" id="pills-tabContent">
    <div class="tab-pane fade show active" id="pills-input" role="tabpanel">
      ...
      <div class="table-responsive">
        <table class="table table-sm align-middle">
          <thead><tr>
            <th>Waktu</th><th>Barang</th><th>Nama Penginput</th><th>Jumlah</th>
          </tr></thead>
          <tbody>
    ...
    <div class="tab-pane fade" id="pills-borrow" role="tabpanel">
      ...
      <div class="table-responsive">
        <table class="table table-sm align-middle">
          <thead><tr>
            <th>Waktu</th><th>Aksi</th><th>Barang</th><th>Nama</th><th>Jumlah</th>
          </tr></thead>
          <tbody>
    ...
    <div class="tab-pane fade" id="pills-take" role="tabpanel">
      ...
      <div class="table-responsive">
        <table class="table table-sm align-middle">
          <thead><tr>
            <th>Waktu</th><th>Barang</th><th>Nama Pengambil</th><th>Jumlah</th>
          </tr></thead>
          <tbody>
