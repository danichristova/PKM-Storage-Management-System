    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="nav">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item"><a class="nav-link" href="<?php echo h(BASE_URL . 'add_item.php'); ?>">Input Barang</a>
          </li>
          ...
          <?php if (isset($_SESSION['admin'])): ?>
            <li class="nav-item"><a class="nav-link" href="<?php echo h(BASE_URL . 'logs.php'); ?>">Log</a></li>
          <?php endif; ?>
          <?php if (isset($_SESSION['admin'])): ?>
